...
[
    ...
    {:from => 'elasticsearch-data', :to => 'user-app'},
    {:from => 'volume-app', :to => 'os'},
    {:from => 'volume-app', :to => 'compute'},
    {:from => 'hostname', :to => 'os'},
    {:from => 'user-app', :to => 'volume-blockstorage'},
    {:from => 'elasticsearch-data', :to => 'volume-app'}, # solrcloud need access to mount point from volume-app
    {:from => 'elasticsearch-data', :to => 'volume-blockstorage'},
    {:from => 'volume-blockstorage', :to => 'storage'},
    {:from => 'storage', :to => 'compute'},
    {:from => 'storage', :to => 'os'},
    {:from => 'user-app',      :to => 'compute'},
    {:from => 'volume-blockstorage',  :to => 'compute'},
    {:from => 'elasticsearch-data', :to => 'java'  },
    {:from => 'elasticsearch-data', :to => 'hostname'}].each do |link|
...
# managed_via
['elasticsearch-data', 'user-app', 'java', 'volume-app', 'storage', 'volume-blockstorage'].each do |from|
