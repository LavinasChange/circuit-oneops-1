...
default[:zookeeper][:mirror] = "https://repository.walmart.com/repository/apache-dist-archive/zookeeper/zookeeper-#{default[:zookeeper][:version]}/zookeeper-#{default[:zookeeper][:version]}.tar.gz"
